...
Replay, Replay2, Exit, RedTurn, YellowTurn = PhotoImage(file ='button/replay/replay.png'), PhotoImage(file='button/replay/replay2.png'), PhotoImage(file ='button/exit.png'), PhotoImage(file ='game_board/red/red_turn.png'), PhotoImage(file ='game_board/yellow/yellow_turn.png')
...
# test toute les possibilités de victoire, si une victoire est détectée renvoie 1 à la fonction victoire qui affiche la victoire jaune
            ...
            if p[i][c-1]==1 and c-1>=0 and p[i][c-2]==1 and c-2>=0 and p[i][c-3]==1 and c-3>=0: return victoire(1)
            if p[i][c-1]==1 and c-1>=0 and p[i][c-2]==1 and c-2>=0 and p[i][c+1]==1 and c+1<=6: return victoire(1)
            if p[i][c-1]==1 and c-1>=0 and p[i][c+1]==1 and c+1<=6 and p[i][c+2]==1 and c+2<=6: return victoire(1)
            if p[i][c+1]==1 and c+1<=6 and p[i][c+2]==1 and c+2<=6 and p[i][c+3]==1 and c+3<=6: return victoire(1)
            if p[i][c+1]==1 and c+1<=6 and p[i][c+2]==1 and c+2<=6 and p[i][c-1]==1 and c-1>=0: return victoire(1)
###############################################################################
            # detection de victoire verticale
            if p[i-1][c]==1 and i-1>=0 and p[i-2][c]==1 and i-2>=0 and p[i-3][c]==1 and i-3>=0: return victoire(1)
            if p[i-1][c]==1 and i-1>=0 and p[i-2][c]==1 and i-2>=0 and p[i+1][c]==1 and i+1<=5: return victoire(1)
            if p[i-1][c]==1 and i-1>=0 and p[i+1][c]==1 and i+1<=5 and p[i+2][c]==1 and i+2<=5: return victoire(1)
            if p[i+1][c]==1 and i+1<=5 and p[i+2][c]==1 and i+2<=5 and p[i+3][c]==1 and i+3<=5: return victoire(1)
            if p[i+1][c]==1 and i+1<=5 and p[i+2][c]==1 and i+2<=5 and p[i-1][c]==1 and i-1>=0: return victoire(1)
##################################################################################
            # detection de victoire diagonale gauche de haut en bas
            if p[i+1][c+1]==1 and i+1<=5 and c+1<=6 and p[i+2][c+2]==1 and i+2<=5 and c+2<=6 and p[i+3][c+3]==1 and i+3<=5 and c+3<=6: return victoire(1)
            if p[i+1][c+1]==1 and i+1<=5 and c+1<=6 and p[i+2][c+2]==1 and i+2<=5 and c+2<=6 and p[i-1][c-1]==1 and i-1>=0 and c-1>=0: return victoire(1)
            if p[i+1][c+1]==1 and i+1<=5 and c+1<=6 and p[i-1][c-1]==1 and i-1>=0 and c-1>=0 and p[i-2][c-2]==1 and i-2>=0 and c-2>=0: return victoire(1)
            if p[i-1][c-1]==1 and i-1>=0 and c-1>=0 and p[i-2][c-2]==1 and i-2>=0 and c-2>=0 and p[i-3][c-3]==1 and i-3>=0 and c-3>=0: return victoire(1)
            if p[i-1][c-1]==1 and i-1>=0 and c-1>=0 and p[i-2][c-2]==1 and i-2>=0 and c-2>=0 and p[i+1][c+1]==1 and i+1<=5 and c-1>=0: return victoire(1)
            if p[i-1][c-1]==1 and i-1>=0 and c-1>=0 and p[i+1][c+1]==1 and i+1<=5 and c+1<=6 and p[i+2][c+2]==1 and i+2<=5 and c+2<=6: return victoire(1)
##################################################################################
            # detection de victoire diagonale droite de haut en bas
            if p[i-1][c+1]==1 and i-1>=0 and c+1<=6 and p[i-2][c+2]==1 and i-2>=0 and c+2<=6 and p[i-3][c+3]==1 and i-3>=0 and c+3<=6: return victoire(1)
            if p[i-1][c+1]==1 and i-1>=0 and c+1<=6 and p[i-2][c+2]==1 and i-2>=0 and c+2<=6 and p[i+1][c-1]==1 and i+1<=5 and c-1>=0: return victoire(1)
            if p[i-1][c+1]==1 and i-1>=0 and c+1<=6 and p[i+1][c-1]==1 and i+1<=5 and c-1>=0 and p[i+2][c-2]==1 and i+2<=5 and c-2>=0: return victoire(1)
            if p[i+1][c-1]==1 and i+1<=5 and c-1>=0 and p[i+2][c-2]==1 and i+2<=5 and c-2>=0 and p[i+3][c-3]==1 and i+3<=5 and c-3>=0: return victoire(1)
            if p[i+1][c-1]==1 and i+1<=5 and c-1>=0 and p[i+2][c-2]==1 and i+2<=5 and c-2>=0 and p[i-1][c+1]==1 and i-1>=0 and c+1<=6: return victoire(1)
            if p[i+1][c-1]==1 and i+1<=5 and c-1>=0 and p[i-1][c+1]==1 and i-1>=0 and c+1<=6 and p[i-2][c+2]==1 and i-2>=0 and c+2<=6: return victoire(1)
##################################################################################
...
# test toute les possibilités de victoire, si une victoire est détectée renvoie 2 à la fonction victoire qui affiche la victoire rouge 
            # detection de victoire horizontale
            if p[i][c-1]==2 and c-1>=0 and p[i][c-2]==2 and c-2>=0 and p[i][c-3]==2 and c-3>=0: return victoire(2)
            if p[i][c-1]==2 and c-1>=0 and p[i][c-2]==2 and c-2>=0 and p[i][c+1]==2 and c+1<=6: return victoire(2)
            if p[i][c-1]==2 and c-1>=0 and p[i][c+1]==2 and c+1<=6 and p[i][c+2]==2 and c+2<=6: return victoire(2)
            if p[i][c+1]==2 and c+1<=6 and p[i][c+2]==2 and c+2<=6 and p[i][c+3]==2 and c+3<=6: return victoire(2)
            if p[i][c+1]==2 and c+1<=6 and p[i][c+2]==2 and c+2<=6 and p[i][c-1]==2 and c-1>=0: return victoire(2)
################################################################################
            # detection de victoire verticale
            if p[i-1][c]==2 and i-1>=0 and p[i-2][c]==2 and i-2>=0 and p[i-3][c]==2 and i-3>=0: return victoire(2)
            if p[i-1][c]==2 and i-1>=0 and p[i-2][c]==2 and i-2>=0 and p[i+1][c]==2 and i+1<=5: return victoire(2)
            if p[i-1][c]==2 and i-1>=0 and p[i+1][c]==2 and i+1<=5 and p[i+2][c]==2 and i+2<=5: return victoire(2)
            if p[i+1][c]==2 and i+1<=5 and p[i+2][c]==2 and i+2<=5 and p[i+3][c]==2 and i+3<=5: return victoire(2)
            if p[i+1][c]==2 and i+1<=5 and p[i+2][c]==2 and i+2<=5 and p[i-1][c]==2 and i-1>=0: return victoire(2)
##################################################################################
            # detection de victoire diagonale gauche de haut en bas
            if p[i+1][c+1]==2 and i+1<=5 and c+1<=6 and p[i+2][c+2]==2 and i+2<=5 and c+2<=6 and p[i+3][c+3]==2 and i+3<=5 and c+3<=6: return victoire(2)
            if p[i+1][c+1]==2 and i+1<=5 and c+1<=6 and p[i+2][c+2]==2 and i+2<=5 and c+2<=6 and p[i-1][c-1]==2 and i-1>=0 and c-1>=0: return victoire(2)
            if p[i+1][c+1]==2 and i+1<=5 and c+1<=6 and p[i-1][c-1]==2 and i-1>=0 and c-1>=0 and p[i-2][c-2]==2 and i-2>=0 and c-2>=0: return victoire(2)
            if p[i-1][c-1]==2 and i-1>=0 and c-1>=0 and p[i-2][c-2]==2 and i-2>=0 and c-2>=0 and p[i-3][c-3]==2 and i-3>=0 and c-3>=0: return victoire(2)
            if p[i-1][c-1]==2 and i-1>=0 and c-1>=0 and p[i-2][c-2]==2 and i-2>=0 and c-2>=0 and p[i+1][c+1]==2 and i+1<=5 and c-1>=0: return victoire(2)
            if p[i-1][c-1]==2 and i-1>=0 and c-1>=0 and p[i+1][c+1]==2 and i+1<=5 and c+1<=6 and p[i+2][c+2]==2 and i+2<=5 and c+2<=6: return victoire(2)
##################################################################################
            # detection de victoire diagonale droite de haut en bas
            if p[i-1][c+1]==2 and i-1>=0 and c+1<=6 and p[i-2][c+2]==2 and i-2>=0 and c+2<=6 and p[i-3][c+3]==2 and i-3>=0 and c+3<=6: return victoire(2)
            if p[i-1][c+1]==2 and i-1>=0 and c+1<=6 and p[i-2][c+2]==2 and i-2>=0 and c+2<=6 and p[i+1][c-1]==2 and i+1<=5 and c-1>=0: return victoire(2)
            if p[i-1][c+1]==2 and i-1>=0 and c+1<=6 and p[i+1][c-1]==2 and i+1<=5 and c-1>=0 and p[i+2][c-2]==2 and i+2<=5 and c-2>=0: return victoire(2)
            if p[i+1][c-1]==2 and i+1<=5 and c-1>=0 and p[i+2][c-2]==2 and i+2<=5 and c-2>=0 and p[i+3][c-3]==2 and i+3<=5 and c-3>=0: return victoire(2)
            if p[i+1][c-1]==2 and i+1<=5 and c-1>=0 and p[i+2][c-2]==2 and i+2<=5 and c-2>=0 and p[i-1][c+1]==2 and i-1>=0 and c+1<=6: return victoire(2)
            if p[i+1][c-1]==2 and i+1<=5 and c-1>=0 and p[i-1][c+1]==2 and i-1>=0 and c+1<=6 and p[i-2][c+2]==2 and i-2>=0 and c+2<=6: return victoire(2)
##################################################################################
            # détecte si le plateau est remplie de pion si oui renvoie 3 à la fonction victoire qui fait une égalité
            if 0 not in p[0]: return victoire(3)
